...
class Portfolio extends React.Component {
  ...
  items() {
    if (this.state.showPortfolio || this.context.height === 'auto') {
      ...
      console.log('state.col', this.state.col)
      return items.map((value, index) => {
      console.log('in items()', value.content.frontmatter.text)
        if (
          ...
          !this.state.category
            ...
            return( 
              ...
              <div
                ...
                key={index}
              >
                <AnimationContainer delay={200} style={{float: 'left'}}animation="fadeIn" key={index}>
                  <img
                    src={
                ...
                <div style={{gridColumn: 2, marginLeft: '30px', color:'#fff'}} dangerouslySetInnerHTML={{__html: value.content.frontmatter.text}}/>
                </div>
              )
          }else{ 
