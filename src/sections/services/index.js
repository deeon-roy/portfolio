        ...
        <Row>
          ...
          <Col md={4} className="service">
            <AnimationContainer delay={200} animation="fadeInLeft fast">
              ...
              <h4>MERN Web Development</h4>
              <p>
                Developing fast and easy to use interactive web apps
              </p>
            </AnimationContainer>
          </Col>
          <Col md={4} className="service border-side">
            <AnimationContainer delay={400} animation="fadeInDown fast">
              ...
              <p>
                Experience managing a team of 30+ members
              </p>
            </AnimationContainer>
          </Col>
          <Col md={4} className="service">
            <AnimationContainer delay={600} animation="fadeInRight fast">
              ...
              <h4>UI/UX Design</h4>
              <p>
                Keeping to design principles to create sites that flow well
              </p>
            </AnimationContainer>
          </Col>
          <Col md={4} className="service border-side">
